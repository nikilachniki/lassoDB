...
import type { CatalogueEntry, EntriesFile, Work, WorksFile } from './types'
...
// Druck, in dem es erschienen ist). Einmal als Map aufgebaut, statt bei jeder
// Detailseite erneut linear durch alle 1979 Eintraege zu suchen.
